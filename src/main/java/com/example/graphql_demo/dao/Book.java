...
public class Book {
    ...
    static {
        books.add(new Book("9dc8e3f0-3358-419f-9b81-09c46f7151d8", "射鵰英雄傳",
            "96b5b8f1-9be5-4a50-a20f-5a2dd87f2062", 918, TimeUtils.generateByYYYYMMDD(1957, 1, 1),
        ...
        books.add(new Book("455f0764-2354-4604-b0e3-22c306530715", "神鵰俠侶",
            "96b5b8f1-9be5-4a50-a20f-5a2dd87f2062", 979, TimeUtils.generateByYYYYMMDD(1959, 5, 20),
        ...
        books.add(new Book("d54c639e-b846-4a9a-adf8-0bd55eee223d", "倚天屠龍記",
            "96b5b8f1-9be5-4a50-a20f-5a2dd87f2062", 956, TimeUtils.generateByYYYYMMDD(1961, 7, 6),
            "以安徽農民朱元璋揭竿而起建立明朝天下為背景，以張無忌的成長為線索，敍寫江湖上的各幫各派、各種人物的恩怨情仇，它把中國歷史上元朝的興衰和江湖道義、恩仇平行交叉起來。該書表達了作者既反對異族侵略，也反對本民族暴政的思想。"));
        books.add(new Book("c63c09d7-4a48-4b7c-a1e5-d26932309f11", "背影",
            "d989a4d2-e6de-4626-9f6f-f43f9d8e4032", 1, TimeUtils.generateByYYYYMMDD(1925, 1, 1),
        ...
        books.add(new Book("4c88dec6-fa58-4d5c-b2f1-913d239ec68f", "傾城之戀",
            "588ba158-afa9-4d9e-af61-944dc6532736", 223, TimeUtils.generateByYYYYMMDD(1943, 9, 1),
